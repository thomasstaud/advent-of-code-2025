...
main = do
    file <- readFile "inputs/04.txt"
    let mat = parse file
    let initial = stacks mat
    print $ part1 mat initial
    print $ part2 mat initial

part1 mat initial = let
    final = stacks $ reduce mat . mapToAdj $ mat
    in initial - final

part2 mat initial = step 0 initial mat
